...
assess robustness. Training and evaluation are conducted for a fixed number of 
epochs, it turns out that 20 is enough, and the best accuracy achieved is documented.
%
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Comparison of testing and validation accuracy per epoch for MLCM and the 
    Perceptron (Single Layer Network  - SLN) on MNIST (Fig.  
    \ref{fig:mnist_exp1}) and Projected MNIST (Fig. \ref{fig:emnist_exp1}).}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Comparison of testing and validation accuracy per epoch for MLCM and the 
    Perceptron (Single Layer Network  - SLN) on Fashion MNIST (Fig.  
    \ref{fig:fashion_mnist_exp1}) and Projected MNIST (Fig. \ref{fig:efashion_mnist_exp1}).}
    \label{fig:mlcm_vs_perceptron}
\end{figure}
