...
\textcolor{red}{To this end, we outline two main experimental protocols. The first 
...
advantages or drawbacks. The second experiment investigates a modification to the 
original MLCM design, switching the use of binary \(\{0,1\}\) states, to enforce neural 
sparsity, and assesses their impact on empirical behavior. \\}
